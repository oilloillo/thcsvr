...
function c20155.initial_effect(c)
	...
	e1:SetCost(c20155.cost)
	e1:SetTarget(c20155.target)
...
function c20155.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>-1
		and Duel.IsExistingMatchingCard(c20155.filter,tp,LOCATION_EXTRA,0,1,nil,e,tp) end

...
function c23185.addc(e,tp,eg,ep,ev,re,r,rp)
	...
	local n=e:GetHandler():GetCounter(0x208a)
	local ct=n+2
	if tc:IsFaceup() and tc:IsRelateToEffect(e) then
		e:GetHandler():RemoveCounter(tp,0x208a,n,REASON_EFFECT)
		tc:AddCounter(0x208a,ct)
...
function c23185.costfilter(c,lv,tp)
	local lv=c:GetLevel()+c:GetRank()+c:GetCounter(0x208a)

...
function c20171.initial_effect(c)
	...
	e1:SetTarget(c20171.target)
	e1:SetOperation(c20171.activate)
	c:RegisterEffect(e1)
end
function c20171.filter(c)
	return bit.band(c:GetReason(),REASON_DISCARD)~=0 and c:IsSetCard(0x186) and c:IsAbleToHand()
end

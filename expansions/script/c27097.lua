...
function c27097.filter(c,e,tp)
	return c:IsSetCard(0x912) and c:IsCanBeSpecialSummoned(e,0,tp,false,true) 
end
function c27097.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>1
		and Duel.IsExistingMatchingCard(c27097.filter,tp,LOCATION_PZONE,0,2,nil,e,tp) 
		end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.GetMatchingGroup(c27097.filter,tp,LOCATION_PZONE,0,nil,e,tp)

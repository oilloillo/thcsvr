...
function c20050.ctop(e,tp,eg,ep,ev,re,r,rp)
	if eg:IsExists(c20050.ctfilter,1,nil) then
		e:GetHandler():AddCounter(0x208b,1)
	end
end
function c20050.cost1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsCanRemoveCounter(tp,1,0,0x208b,3,REASON_COST) end
	Duel.Hint(HINT_OPSELECTED,1-tp,e:GetDescription())
	Duel.RemoveCounter(tp,1,0,0x208b,3,REASON_COST)
end
...
function c20050.cost2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsCanRemoveCounter(tp,1,0,0x208b,1,REASON_COST) end
	Duel.Hint(HINT_OPSELECTED,1-tp,e:GetDescription())
	Duel.RemoveCounter(tp,1,0,0x208b,1,REASON_COST)
end
...
function c20050.cost3(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsCanRemoveCounter(tp,1,0,0x208b,5,REASON_COST) end
	Duel.Hint(HINT_OPSELECTED,1-tp,e:GetDescription())
	Duel.RemoveCounter(tp,1,0,0x208b,5,REASON_COST)
end
...
function c20050.atkval(e,c)
	return e:GetHandler():GetCounter(0x208b)*100
end

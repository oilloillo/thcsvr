...
function c24125.initial_effect(c)
	...
	e1:SetCondition(c24125.condition)
	e1:SetOperation(c24125.activate)
	c:RegisterEffect(e1)
	--battle target
...
function c24125.condition(e,tp,eg,ep,ev,re,r,rp)
	return tp~=Duel.GetTurnPlayer()
end
function c24125.activate(e,tp,eg,ep,ev,re,r,rp)

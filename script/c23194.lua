...
function c23194.op(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 and Duel.SpecialSummon(g,0,tp,tp,false,false,POS_FACEUP_DEFENCE)>0 and e:GetHandler():IsCanAddCounter(0x208a,1) then
...
function c23194.adcfilter(c)
	return c:IsFaceup() and c:IsCanAddCounter(0x208a,1)
end

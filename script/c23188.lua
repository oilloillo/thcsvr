...
function c23188.tg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsPlayerCanDraw(tp,1) and e:GetHandler():IsCanAddCounter(0x208a,1) end
	Duel.SetOperationInfo(0,CATEGORY_DRAW,nil,0,tp,1)
end
function c23188.op(e,tp,eg,ep,ev,re,r,rp)
	if not e:GetHandler():IsCanAddCounter(0x208a,1) then return end

...
function c24023.initial_effect(c)
	...
	e1:SetCondition(c24023.condition)
	e1:SetOperation(c24023.activate)
	c:RegisterEffect(e1)
	--battle target
...
function c24023.condition(e,tp,eg,ep,ev,re,r,rp)
	return tp~=Duel.GetTurnPlayer()
end
function c24023.activate(e,tp,eg,ep,ev,re,r,rp)

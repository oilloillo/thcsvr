...
function c20086.addc(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():IsRelateToEffect(e) then
		e:GetHandler():AddCounter(0x208b,2)
	end
end
function c20086.descost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsCanRemoveCounter(tp,0x208b,4,REASON_COST) end
	e:GetHandler():RemoveCounter(tp,0x208b,4,REASON_COST)
end
...
function c20086.desrepcon(e)
	return e:GetHandler():GetCounter(0x208b)>1
end
function c20086.condition(e)
	return e:GetHandler():GetCounter(0x208b)>3
end
function c20086.igcon(e)
	return e:GetHandler():GetCounter(0x208b)>5
end

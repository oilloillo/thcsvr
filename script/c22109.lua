...
function c22109.ctop(e,tp,eg,ep,ev,re,r,rp)
	...
	e:GetHandler():AddCounter(0x208c,ct)
end
function c22109.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsCanRemoveCounter(tp,1,1,0x208c,2,REASON_COST) end
	Duel.Hint(HINT_OPSELECTED,1-tp,e:GetDescription())
	Duel.RemoveCounter(tp,1,1,0x208c,2,REASON_COST)
end
